...
// Updated to only include category-related params
function createSearchParamsHelper(filterParams) {
  const queryParams = []

  for (const [key, value] of Object.entries(filterParams)) {
    // Only process category and equipment type filters
...
function ShoppingListing() {
  ...
  function handleFilter(getSectionId, getCurrentOption) {
    // Only handle category and equipment type filters
  ...
  useEffect(() => {
    if (filters && Object.keys(filters).length > 0) {
      ...
      setSearchParams(createQueryString) //Fixed useEffect hook
    }
    ...
    <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-6 p-4 md:p-6">
      ...
      <div className="bg-background w-full rounded-lg shadow-sm">
        <div className="p-4 border-b flex items-center justify-between">
          <h2 className="text-lg font-extrabold">Gym Equipment</h2>
